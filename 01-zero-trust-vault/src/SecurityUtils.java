...
public class SecurityUtils {
    ...
    // Advanced Encryption Standard - Padrão mundial de criptografia simétrica
    ...
    private static SecretKeySpec gerarChave(char[] senhaMestre) throws Exception {
        ...
        // Aplica SHA-256 para garantir uma chave íntegra de tamanho fixo (32 bytes / 256 bits)
        MessageDigest sha = MessageDigest.getInstance("SHA-256"); 
        byte[] chaveBytes = sha.digest(senhaBytes); 

        // Higienização imediata da memória RAM
    ...
    /**
     * Criptografa o texto plano em formato Base64 utilizando criptografia AES.
     */
    public static String criptografar(String textoLimpo, char[] senhaMestre) throws Exception {
        ...
        // Codificação em Base64 para garantir a persistência segura em arquivos de texto
        return Base64.getEncoder().encodeToString(textoCriptografadoBytes);
    }

    /**
     * Decriptografa o texto cifrado Base64 retornando à String original.
     */
